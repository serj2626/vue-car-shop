  ...
  >
    ...
    >
      <div class="flex p-5 flex-col justify-center items-center h-32 bg-indigo-600">
        <h3 class="text-lg text-white">Чем мы можем помочь?</h3>
        <p class="text-white opacity-50">Обычно мы отвечаем в течение нескольких часов</p>
      </div>
      <div class="bg-gray-50 flex-grow p-6">
        ...
        >
          ...
          <div class="mb-4">
            <label for="tel" class="block mb-2 text-sm text-gray-600 dark:text-gray-400"
              >Телефон</label
            >
            <input
              type="tel"
          ...
          <p class="text-xs text-center text-gray-400" id="result"></p>
        </form>
      </div>
    </div>
    <button
