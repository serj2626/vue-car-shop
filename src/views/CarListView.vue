    ...
    <div class="">
      ...
      <div class="grid grid-cols-4 gap-3 ">
        <div v-for="car in cars" :key="car.id">
          ...
          <div class="rounded-md overflow-hidden shadow-md my-10 border-spacing-4 pt-3   
          cursor-pointer hover:-translate-y-1 hover:shadow-2xl hover:border-gray-500">
            <img class="object-cover h-48 w-96 " :src="car.img" alt="Forest" />
            <div class="px-6 py-4">
              <div class="font-bold text-xl mb-2">{{ car.brand }} {{ car.model }}</div>

              <p class="text-gray-700 text-base">
                Автомобиль {{ car.brand }} {{ car.model }} продается в нашем магазине
                по цене {{ car.price }} рублей.
              </p>
            </div>
